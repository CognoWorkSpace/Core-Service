...
def upload(file, collection_name):
    try:
        ...
        embeddings = create_embedding(current_app.config.get("OPENAI", const.OPENAI))  # Creating embedding method
        connection_string = create_connection_string(
            current_app.config.get("MILVUS", const.MILVUS))  # Creating Milvus connection string

        # Creating Milvus Database
        database = create_database(current_app.config.get("DATABASE", const.MILVUS),
